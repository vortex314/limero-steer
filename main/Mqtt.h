...
class Mqtt : public Actor {
 ...
 public:
  ...
  //   response);
  //    static void onConnectSuccess(void* context, MQTTAsync_successData*
  //    response);
  void subscribe(Cbor& cbor);
  //    static void onSubscribeSuccess(void* context, MQTTAsync_successData*
  //    response);
  //   static void onSubscribeFailure(void* context, MQTTAsync_failureData*
  //   response);
  void publish(Cbor& cbor);
  //    static void onPublishSuccess(void* context, MQTTAsync_successData*
  //    response);
  //    static void onPublishFailure(void* context, MQTTAsync_failureData*
  //    response);
