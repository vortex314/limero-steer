...
Mqtt::Mqtt(const char *name, uint32_t maxSize)
    : Actor(name), _host(40), _port(1883), _clientId(30), _user(20),
      _password(20), _willTopic(30), _willMessage(30), _willQos(0),
      _willRetain(false), _keepAlive(20), _cleanSession(1), _msgid(0),
      _prefix(20), _topic(TOPIC_LENGTH), _message(maxSize)
{
  _lastSrc = 0;
  _thisMqtt = this;
}
